...
// Placeholder images
const reviewsHeroImage = "/satisfiedgardnercustomer.webp";
const customerServiceImage = "/GardnerEmployeeArrival.webp";
      ...
      <section className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button size="lg" className="border-2 border-white/60 text-white hover:bg-white hover:text-gray-900 px-10 py-4 rounded-xl shadow-lg transition-all duration-300 group bg-transparent">
              <span className="flex items-center justify-center gap-3">
