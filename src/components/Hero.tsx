      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-left animate-fade-in">
            <div className="mb-6 animate-slide-up">
              <h1
                className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-3 text-white drop-shadow-lg whitespace-nowrap tracking-tight"
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              {/* Google */}
              <a href="/reviews" className="flex items-center gap-3 group hover-lift" aria-label="Read our reviews">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              {/* Call now */}
              <a href="tel:9512464337" aria-label="Call Gardner Plumbing at (951) 246-4337" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-red-600 via-red-500 to-red-600 hover:from-red-700 hover:via-red-600 hover:to-red-700 text-white px-6 py-3 text-base font-bold shadow-luxury transition-all duration-500 focus:ring-4 focus:ring-red-500/30 rounded-xl border border-red-400/20 hover-lift group relative"
                  style={{
                    boxShadow: `
              ...
              {/* Free estimate */}
              <a href="/contact" className="w-full sm:w-auto" aria-label="Get a free plumbing estimate">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full border-2 border-white/30 bg-white/10 hover:bg-white/20 text-white px-6 py-3 text-base font-bold backdrop-blur-sm transition-all duration-500 focus:ring-4 focus:ring-white/30 rounded-xl hover-lift group"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">Get Free Estimate</span>
                </Button>
              </a>
            </div>
          </div>
          ...
          <div className="animate-fade-in">
            <div
              className="relative overflow-hidden rounded-3xl p-8 w-full border border-white/20"
              style={{
            ...
            >
              ...
              <div className="text-center mb-6 relative z-10">
                <h3 className="text-2xl font-bold text-white mb-2">Get Free Estimate</h3>
                <p className="text-sm text-gray-300 leading-relaxed">Schedule your free consultation today. We'll call you within 24 hours.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                ...
                <div className="pt-4">
                  <Button
                    ...
                    aria-disabled={!formData.consent}
                  >
                    <span className="relative z-10 flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 animate-fade-in">
          ...
          >
            ...
            <div className="absolute top-2 right-2 w-16 h-16 bg-blue-500/8 rounded-full blur-2xl" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-black/10 rounded-2xl" />
            <div className="absolute top-2 right-2 w-16 h-16 bg-green-500/8 rounded-full blur-2xl" />
            <div className="relative z-10 flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center shadow-glow group-hover:scale-110 transition-transform duration-300 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-green-400/20 to-transparent rounded-xl" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-black/10 rounded-2xl" />
            <div className="absolute top-2 right-2 w-16 h-16 bg-purple-500/8 rounded-full blur-2xl" />
            <div className="relative z-10 flex items-center gap-4">
