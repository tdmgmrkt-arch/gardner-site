...
// UPDATE: Replace with your actual image paths for the inspection page
const IntroImage = "/techsinspectingfaucet.webp";
const beforeafterImage = "/inspectionrisk.webp";
const whychooseusImage = "/gardnertech2.webp";
const KeyFocusImage = "/bathroomsinkinspection.webp";
