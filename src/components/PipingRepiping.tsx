...
export function PipingRepiping() {
  const emergencyReasons = [
    "Burst or severely leaking pipe",
    "Repeated pinhole leaks",
    "Major corrosion / rusty water",
    "Sudden loss of water pressure",
    "Polybutylene or failing galvanized piping",
    "Slab leak requiring bypass/repipe",
    "Multiple simultaneous leaks",
    "Extensive water damage risk",
  ];
  ...
  const faqs = [
    {
      question: "When should I consider a whole-home repipe?",
      answer:
        "If your home has frequent leaks, low water pressure, rusty or discolored water, or original galvanized/polybutylene lines, repiping is often the most reliable long-term fix. It improves pressure, water quality, and eliminates recurring repairs.",
    },
    {
      question: "What pipe materials do you install?",
      answer:
        "We install copper (Type L) and PEX (A/B) depending on application, local code, and your preferences. Both are code-compliant and backed by strong manufacturer warranties.",
    },
    {
      question: "How long does a repipe take?",
      answer:
        "Most single-family homes are completed in 1–3 days, plus 1 day for wall/ceiling patching where needed. We stage work to minimize downtime; you’ll usually have water back on the same day.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We can discuss phased solutions and provide documentation for financing providers. Ask us during your estimate.",
    },
    {
      question: "Is a repipe messy?",
      answer:
        "We use dust control, floor protection, and clean as we go. Openings are kept as small as practical and patched after inspections.",
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Replace aging or problem piping throughout your home for long-term reliability and better water flow.",
      features: ["Copper or PEX", "Code Compliant", "Fast Turnaround", "Warranty Included"],
    },
    {
      icon: Droplets,
      title: "Pipe Repair & Replacement",
      description:
        "Targeted repairs for localized leaks, corroded sections, or upgrades during remodels.",
      features: ["Leak Stops", "Sectional Replacement", "Pressure Tested", "Permanent Fixes"],
    },
    {
      icon: Zap,
      title: "Slab Leak Bypass / Reroute",
      description:
        "Avoid breaking concrete by rerouting new lines through walls/ceilings for clean, lasting results.",
      features: ["Minimal Disruption", "Cleaner Finish", "Pressure Balanced", "Long-Term Solution"],
    },
    {
      icon: Shield,
      title: "Material Upgrades",
      description:
        "Upgrade failing polybutylene or galvanized to modern, safe, and efficient piping.",
      features: ["Better Water Quality", "Higher Flow", "Corrosion Resistant", "Manufacturer Warranties"],
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "Modern materials and pro installation reduce failures and emergency calls for years to come.",
    },
    {
      icon: Droplets,
      title: "Better Water Quality",
      description:
        "Eliminate rust, scale, and metallic taste from old lines for cleaner, clearer water.",
    },
    {
      icon: DollarSign,
      title: "Lower Lifetime Cost",
      description:
        "Stop paying for repeat leak repairs—repipe once and be done, with strong warranties.",
    },
    {
      icon: Award,
      title: "Permits & Code",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              <nav className="mb-6">
                <div className="flex items-center space-x-2 text-sm text-gray-400">
                  ...
                  <span>Services</span>
                  <ArrowRight className="h-4 w-4" />
                  <span className="text-red-400">Piping & Repiping</span>
                </div>
              </nav>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Replace failing pipes, stop recurring leaks, and improve water pressure with
                clean, code-compliant repipes throughout Riverside County.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  { icon: DollarSign, text: "Long-Term Savings" },
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="tel:9512464337" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-8 py-4 rounded-xl shadow-lg border border-red-400/20 group"
                  >
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <img
                  src={IntroImage}
                  alt="Technician performing professional repiping work"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl" />
                 <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md animate-fade-in bg-black/60 backdrop-blur-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Copper & PEX</div>
                      <div className="text-gray-300 text-xs">Modern Materials</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">Burst Pipe?</span>
              </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              From full copper/PEX repipes to targeted line replacements and slab leak bypasses,
              we deliver clean, efficient, code-compliant results.
            </p>
          </div>
          ...
          <div className="glassmorphism-dark rounded-3xl p-8 border border-white/10 shadow-luxury">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">See the Difference a Professional Repipe Makes</h3>
                <div className="space-y-4 text-gray-300">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-1 flex-shrink-0" />
                    <span>Eliminates recurring leaks and costly water damage</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-1 flex-shrink-0" />
                    <span>Improves water pressure and flow throughout the home</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-1 flex-shrink-0" />
                    <span>Cleaner water with corrosion-resistant materials</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-1 flex-shrink-0" />
                    <span>Adds value and peace of mind with strong warranties</span>
                  </div>
                </div>
              </div>
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury">
                  <img
                    ...
                    alt="Before and after repiping comparison"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Professional repiping and pipe repair services with fast response to your location.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Answers to common questions about materials, timelines, and what to expect during a repipe.
            </p>
          </div>
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                Not sure if you need a full repipe? We’ll inspect and give honest options with clear pricing.
              </p>
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Three decades of trusted service. Contact us for a clean, code-compliant repipe.
              </p>
            </div>
