            ...
            <div className="text-left">
              ...
              <div className="mb-6">
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-600/20 to-red-500/20 rounded-full border border-red-500/30 backdrop-blur-sm">
                  ...
                  <span className="text-red-400 font-semibold text-sm uppercase tracking-wider">Premium Services</span>
                </div>
              </div>
          ...
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            ...
            <div className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8" style={{ 
              ...
              <div className="relative flex items-center justify-center gap-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">Residential Services</h3>
              </div>
            </div>
          ...
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            <div className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8" style={{ 
              ...
              <div className="relative flex items-center justify-center gap-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">Commercial Services</h3>
              </div>
            </div>
                      ...
                      <CardContent className="relative z-10 p-8 lg:p-10 flex flex-col flex-grow">
                        <div className="flex flex-col sm:flex-row items-start gap-6 flex-grow">
                          ...
                          <div className="flex-1 text-center sm:text-left">
                            <h4 className="text-2xl font-bold text-white mb-4 group-hover:text-red-100 transition-colors duration-300">{service.title}</h4>
          ...
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            <div className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8" style={{ 
              ...
              <div className="relative flex items-center justify-center gap-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">24/7 Emergency Service</h3>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                <div className="order-2 lg:order-1 text-center lg:text-left">
                  <h4 className="text-2xl sm:text-3xl font-bold text-white mb-6">Always Available When You Need Us</h4>
