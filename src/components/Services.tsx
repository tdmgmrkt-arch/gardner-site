...
const professionalTechnician = "/whychooseusgp.png";
const customerServiceRep = "/gardnercsrep.png";
...
export function Services() {
  const residentialServices: ServiceItem[] = [
    ...
    },
    {
      ...
      link: "/services/bathroom-plumbing", // create this page when ready
    },
  ];
    ...
    <section className="py-16 sm:py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <CardHeader className="text-center pb-4 pt-8 flex-shrink-0">
                          <a href={service.link} className="block focus:outline-none">
                            <div className="relative mb-6">
                              ...
                              <div className="absolute -inset-2 bg-gradient-to-r from-red-600 to-red-500 rounded-2xl opacity-0 group-hover:opacity-20 blur transition-opacity duration-500" />
                            </div>
        ...
        <div className="mb-20 sm:mb-24 animate-slide-up">
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            <div
              className="relative overflow-hidden px-6 sm:py-8 py-6 sm:px-8"
              style={{
                background: `linear-gradient(135deg, #8B0000 0%, #DC2626 50%, #B91C1C 100%)`,
                boxShadow: `
                  inset 0 2px 0 rgba(255, 255, 255, 0.2),
                    ...
                    >
                      ...
                      <CardContent className="relative z-10 p-8 lg:p-10 flex flex-col flex-grow">
                        <div className="flex flex-col sm:flex-row items-start gap-6 flex-grow">
                          <a href={service.link} className="relative mx-auto sm:mx-0 block">
                            <div className="w-20 h-20 bg-gradient-to-br from-red-600/30 to-red-500/30 rounded-2xl flex items-center justify-center group-hover:from-red-600 group-hover:to-red-500 transition-all duration-500 shadow-lg backdrop-blur-sm border border-red-500/20">
                              <Icon className="h-10 w-10 text-red-400 group-hover:text-white transition-all duration-500" />
                            </div>
                            <div className="absolute -inset-2 bg-gradient-to-r from-red-600 to-red-500 rounded-2xl opacity-0 group-hover:opacity-20 blur transition-opacity duration-500" />
                          </a>
                          ...
                          <div className="flex-1 text-center sm:text-left">
                            <a href={service.link} className="no-underline">
                              <h4 className="text-2xl font-bold text-white mb-4 group-hover:text-red-100 transition-colors duration-300">
                                {service.title}
                              </h4>
                            </a>
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                              {service.features.map((f) => (
                                <li
                                  key={f}
                                  className="flex items-center gap-3 text-sm group/item justify-center sm:justify-start"
                                >
                                  <div className="w-5 h-5 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-green-500/30 transition-colors duration-300">
                                    <CheckCircle className="h-3 w-3 text-green-400 transition-transform duration-300" />
                                  </div>
        ...
        <div className="mb-16 sm:mb-20 animate-slide-up">
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            ...
            <a
              ...
              className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8 block focus:outline-none"
              style={{
                background: `linear-gradient(135deg, #8B0000 0%, #DC2626 50%, #B91C1C 100%)`,
                boxShadow: `
                  inset 0 2px 0 rgba(255, 255, 255, 0.2),
            ...
            <div className="p-6 sm:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                  ...
                  <div className="mb-6 flex justify-center lg:justify-start">
                    <a href="/services/emergency-plumbing" className="relative group block">
                      <img
                        ...
                        alt="Professional Gardner Plumbing technician providing reliable emergency service"
                ...
                <div className="flex flex-col order-3 lg:order-2">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={idx}
                        className="flex items-center gap-4 p-4 glassmorphism-dark rounded-xl border border-white/10 hover:border-red-500/30 transition-all duration-300 group/item hover-lift"
                      >
                        ...
                        <div>
                          <div className="font-semibold text-white text-lg group-hover/item:text-red-100 transition-colors duration-300">
                            {item.title}
                          </div>
                          <div className="text-gray-400 text-sm group-hover/item:text-gray-300 transition-colors duration-300">
                            {item.desc}
                          </div>
                        </div>
                      </div>
                ...
                <div className="text-center order-1 lg:order-3 flex flex-col">
                  <div
                    className="relative overflow-hidden rounded-2xl mb-6 shadow-luxury hover-lift"
                    style={{
                  ...
                  >
                    ...
                    <div className="relative p-6 text-center">
                      ...
                      <div className="text-red-100 font-semibold mb-1 drop-shadow-sm">
                  ...
                  <a href="tel:9512464337">
                    <Button
                      size="lg"
                      className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-8 py-4 transition-all duration-300 mt-auto rounded-2xl shadow-luxury border border-red-400/20 hover-lift group"
                    >
