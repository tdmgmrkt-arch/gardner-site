...
const beforeafterImage = "/waterheaterbeforeandafter.webp";
const whychooseusImage = "/waterheater-techs.webp";
const EmergencyImage = "/gardnertecharrival.webp"
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-lg text-gray-300 mb-8 leading-relaxed">
          Hot water problems can’t wait. We provide 24/7 emergency water heater
          repair across Riverside County with fast, reliable response times.
        </p>
      ...
      <div className="relative group">
        <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
          <img
            src={EmergencyImage}
            alt="Emergency water heater repair - technician responding to urgent call"
            className="w-full h-96 object-cover rounded-3xl"
          />
