            ...
            <div className="text-left">
              ...
              <div className="mb-6">
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-600/20 to-red-500/20 rounded-full border border-red-500/30 backdrop-blur-sm">
                  ...
                  <span className="text-red-400 font-semibold text-sm uppercase tracking-wider">Why Choose Us</span>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500 max-w-lg w-full">
                ...
                <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Expert Technician</div>
                      <div className="text-gray-300 text-xs">Licensed & Certified</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            ...
            <div className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8" style={{ 
              ...
              <div className="relative flex items-center justify-center gap-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">Our Achievements</h3>
              </div>
            </div>
                  ...
                  return (
                    <Card key={index} className="group relative border-none overflow-hidden shadow-luxury hover-lift transition-all duration-500 animate-scale-in" style={{ 
                      ...
                      <CardContent className="relative z-10 p-4 sm:p-6 lg:p-8 text-center">
                        ...
                        <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2 sm:mb-3 drop-shadow-sm group-hover:text-red-100 transition-colors duration-300">{achievement.number}</div>
                        <div className="text-gray-300 font-semibold mb-1 sm:mb-2 text-sm sm:text-base lg:text-lg group-hover:text-gray-200 transition-colors duration-300">{achievement.text}</div>
                        <div className="text-gray-400 text-xs sm:text-sm lg:text-base group-hover:text-gray-300 transition-colors duration-300">{achievement.subtext}</div>
                      </CardContent>
                    </Card>
                  );
                })}
        ...
        <div className="mb-16 sm:mb-20 animate-slide-up">
          <div className="glassmorphism-dark rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
            ...
            <div className="relative overflow-hidden px-6 sm:px-8 py-6 sm:py-8" style={{ 
              ...
              <div className="relative flex items-center justify-center gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/30 shadow-inner">
                  <CheckCircle className="h-6 w-6 sm:h-7 sm:w-7 text-white drop-shadow-sm" />
                </div>
                <h3 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">Why We're Different</h3>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative group overflow-hidden">
                ...
                <div className="absolute top-6 left-6 group/badge">
                  <div className="relative overflow-hidden rounded-2xl backdrop-blur-sm transition-all duration-500 hover:scale-105" style={{
                    ...
                    <div className="relative p-4 flex items-center gap-3">
                      <div className="relative">
                        <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg group-hover/badge:from-yellow-300 group-hover/badge:to-yellow-500 transition-all duration-500">
                          <Award className="h-5 w-5 text-white drop-shadow-sm group-hover/badge:scale-110 transition-transform duration-500" />
                        </div>
                        <div className="absolute -inset-1 bg-yellow-400/30 rounded-xl blur-sm opacity-0 group-hover/badge:opacity-100 transition-opacity duration-500"></div>
                      </div>
                      <div>
                        <div className="text-white font-bold text-xl drop-shadow-lg group-hover/badge:text-yellow-100 transition-colors duration-300">30+</div>
                        <div className="text-yellow-300 text-sm font-semibold tracking-wide group-hover/badge:text-yellow-200 transition-colors duration-300">Years Experience</div>
                      </div>
                    </div>
                  </div>
                </div>
                
                <div className="absolute bottom-6 right-6 group/badge" style={{ animationDelay: '200ms' }}>
                  <div className="relative overflow-hidden rounded-2xl backdrop-blur-sm transition-all duration-500 hover:scale-105" style={{
                    background: `linear-gradient(145deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.6) 100%)`,
                    border: `1px solid rgba(255, 215, 0, 0.3)`,
                    boxShadow: `
                    ...
                    <div className="relative p-4 flex items-center gap-3">
                      <div className="relative">
                        <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg group-hover/badge:from-yellow-300 group-hover/badge:to-yellow-500 transition-all duration-500">
                          <Star className="h-5 w-5 text-white drop-shadow-sm group-hover/badge:scale-110 transition-transform duration-500" />
                        </div>
                        <div className="absolute -inset-1 bg-yellow-400/30 rounded-xl blur-sm opacity-0 group-hover/badge:opacity-100 transition-opacity duration-500"></div>
                      </div>
                      <div>
                        <div className="text-white font-bold text-xl drop-shadow-lg group-hover/badge:text-yellow-100 transition-colors duration-300">4.9★</div>
                        <div className="text-yellow-300 text-sm font-semibold tracking-wide group-hover/badge:text-yellow-200 transition-colors duration-300">Customer Rating</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:absolute lg:top-[85%] left-0 right-0 px-4 sm:px-6 lg:px-8 pt-8 lg:pt-0">
                      ...
                      <Card key={index} className="group relative border-none overflow-hidden shadow-luxury hover-lift transition-all duration-500 animate-scale-in" style={{ 
                        ...
                        <div className="relative z-10">
                          <CardHeader className="text-center pb-4 pt-8 flex-shrink-0">
                            <div className="relative mb-6">
                              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-red-600/30 to-red-500/30 rounded-2xl flex items-center justify-center mx-auto group-hover:from-red-600 group-hover:to-red-500 transition-all duration-500 shadow-lg backdrop-blur-sm border border-red-500/20">
                                <IconComponent className="h-8 w-8 sm:h-10 sm:w-10 text-red-400 group-hover:text-white transition-all duration-500 group-hover:scale-110" />
                              </div>
                            ...
                            <h4 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-red-100 transition-colors duration-300">
                              {feature.title.split('\n').map((line, index) => (
                                <span key={index}>
                                  {line}
                          ...
                          <CardContent className="px-6 pb-8 flex flex-col flex-grow">
                            <p className="text-gray-300 mb-4 leading-relaxed text-center group-hover:text-gray-200 transition-colors duration-300">{feature.description}</p>
                            <div className="text-green-400 font-semibold text-sm mb-6 tracking-wide uppercase text-center bg-green-400/10 py-2 px-4 rounded-lg border border-green-400/20">{feature.stats}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-1 text-center sm:text-left">
              <div className="flex items-center gap-3 mb-4 justify-center sm:justify-start">
                <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-red-500 rounded-full flex items-center justify-center shadow-glow">
                  <Shield className="h-5 w-5 text-white" />
                </div>
                <h3 className="text-xl font-bold text-white">Trusted & Reliable</h3>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg transition-all duration-300 group">
                    <item.icon className="h-4 w-4 text-red-400 group-hover:text-red-300 transition-colors duration-300" />
                    <span className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors duration-300">{item.text}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="lg:col-span-1 flex justify-center items-center order-last sm:order-none">
              <div className="relative group">
                <img 
                  ...
                  className="w-24 sm:w-28 lg:w-36 h-auto max-w-full filter drop-shadow-lg group-hover:scale-105 transition-transform duration-300"
                />
            ...
            <div className="lg:col-span-1 text-center">
              <div className="mb-4">
                <div className="text-2xl font-bold text-white mb-2 drop-shadow-sm">(951) 246-4337</div>
                <div className="text-gray-300 text-sm">Call for Free Estimate</div>
              </div>
              <Button className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-6 py-3 transition-all duration-300 w-full sm:w-auto rounded-xl shadow-lg border border-red-400/20 group">
                <span className="flex items-center justify-center gap-2">
                  <UserCheck className="h-4 w-4 group-hover:scale-110 transition-transform duration-300" />
                  Get Quote
                </span>
              </Button>
            </div>
